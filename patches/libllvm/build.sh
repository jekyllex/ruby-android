...
# removed: -DPYTHON_EXECUTABLE, -DLLDB_PYTHON_RELATIVE_PATH, -DLLDB_PYTHON_EXE_RELATIVE_PATH, -DLLDB_PYTHON_EXT_SUFFIX, -DPERL_EXECUTABLE
# added -DLLDB_ENABLE_LIBEDIT, -DLLDB_ENABLE_CURSES
# changed: -DLLDB_ENABLE_PYTHON, -DLLVM_ENABLE_SPHINX, -DSPHINX_OUTPUT_MAN, -DLLVM_INSTALL_UTILS
