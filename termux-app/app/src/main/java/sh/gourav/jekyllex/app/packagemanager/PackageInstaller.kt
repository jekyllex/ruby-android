package sh.gourav.jekyllex.app.packagemanager
...
import sh.gourav.jekyllex.app.packagemanager.Constants.Companion.PACKAGE_INSTALLED_ACTION
        ...
        if (isInstallationOfApkAllowed()) {
            ...
            GlobalScope.launch(Dispatchers.Main) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                    ...
                    val permIntent = Intent(Settings.ACTION_MANAGE_UNKNOWN_APP_SOURCES, Uri.parse("package:sh.gourav.jekyllex"))
    ...
    private fun installAPK(packageName: String) {
        ...
        if (isInstallationOfApkAllowed()) {
            ...
            GlobalScope.launch(Dispatchers.Main) {
                ...
                Toast.makeText(context, "Please allow installation from unknown sources for Termux.", Toast.LENGTH_SHORT).show()
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                    context.startActivity(Intent(Settings.ACTION_MANAGE_UNKNOWN_APP_SOURCES, Uri.parse("package:sh.gourav.jekyllex")))
                }
            }
