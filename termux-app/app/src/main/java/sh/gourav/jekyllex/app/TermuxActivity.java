...
import sh.gourav.jekyllex.terminal.TerminalColors;
...
import sh.gourav.jekyllex.terminal.TextStyle;
import sh.gourav.jekyllex.view.TerminalView;
...
public final class TermuxActivity extends Activity implements ServiceConnection {
    ...
    public static final String TERMUX_FAILSAFE_SESSION_ACTION = "sh.gourav.jekyllex.app.failsafe_session";
    ...
    private static final String RELOAD_STYLE_ACTION = "sh.gourav.jekyllex.app.reload_style";
    ...
    void checkForFontAndColors() {
        try {
            @SuppressLint("SdCardPath") File fontFile = new File("/data/data/sh.gourav.jekyllex/files/home/.termux/font.ttf");
            @SuppressLint("SdCardPath") File colorsFile = new File("/data/data/sh.gourav.jekyllex/files/home/.termux/colors.properties");
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case CONTEXTMENU_STYLING_ID: {
                ...
                stylingIntent.setClassName("sh.gourav.jekyllex.styling", "sh.gourav.jekyllex.styling.TermuxStyleActivity");
                try {
                    ...
                    new AlertDialog.Builder(this).setMessage(R.string.styling_not_installed)
                        .setPositiveButton(R.string.styling_install, (dialog, which) -> startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("http://play.google.com/store/apps/details?id=sh.gourav.jekyllex.styling")))).setNegativeButton(android.R.string.cancel, null).show();
                }
                return true;
            }
