...
import sh.gourav.jekyllex.R;
import sh.gourav.jekyllex.app.packagemanager.PackageInstaller;
import sh.gourav.jekyllex.app.packagemanager.PackageLister;
import sh.gourav.jekyllex.app.packagemanager.PackageUninstaller;
import sh.gourav.jekyllex.terminal.EmulatorDebug;
import sh.gourav.jekyllex.terminal.TerminalSession;
import sh.gourav.jekyllex.terminal.TerminalSession.SessionChangedCallback;
...
public final class TermuxService extends Service implements SessionChangedCallback {
    ...
    public static final String FILES_PATH = "/data/data/sh.gourav.jekyllex/files";
    public static final String PREFIX_PATH = FILES_PATH + "/usr";
    public static final String HOME_PATH = FILES_PATH + "/home";

    private static final int NOTIFICATION_ID = 1337;

    private static final String ACTION_STOP_SERVICE = "sh.gourav.jekyllex.service_stop";

    private static final String ACTION_LOCK_WAKE = "sh.gourav.jekyllex.service_wake_lock";
    private static final String ACTION_UNLOCK_WAKE = "sh.gourav.jekyllex.service_wake_unlock";
    /**
     * Intent action to launch a new terminal session. Executed from TermuxWidgetProvider.
     */
    public static final String ACTION_EXECUTE = "sh.gourav.jekyllex.service_execute";

    public static final String EXTRA_ARGUMENTS = "sh.gourav.jekyllex.execute.arguments";

    public static final String EXTRA_CURRENT_WORKING_DIRECTORY = "sh.gourav.jekyllex.execute.cwd";
    public static final String EXTRA_EXECUTE_IN_BACKGROUND = "sh.gourav.jekyllex.execute.background";

    /*
     * APK service intents
     * */

    private static final String ACTION_INSTALL_PACKAGES = "sh.gourav.jekyllex.install_packages";
    private static final String ACTION_LIST_PACKAGES = "sh.gourav.jekyllex.list_packages";
    private static final String ACTION_UNINSTALL_PACKAGES = "sh.gourav.jekyllex.uninstall_packages";
    ...
    TerminalSession createTermSession(String executablePath, String[] arguments, String cwd, boolean failSafe) {
        ...
        Intent stylingIntent = new Intent("sh.gourav.jekyllex.app.reload_style");
        stylingIntent.putExtra("sh.gourav.jekyllex.app.reload_style", "styling");
